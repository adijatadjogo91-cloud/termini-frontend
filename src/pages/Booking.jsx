...
function Booking() {
  ...
  const [korak, setKorak] = useState(1) // 1=usluga, 2=datum, 3=vrijeme, 4=podaci, 5=potvrda
        ...
        {korak === 2 && (
          <div>
            ...
            <div style={{ background: 'white', borderRadius: '12px', padding: '1.5rem', boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}>
              ...
              />
              {odabranDatum && (
                <button onClick={() => { ucitajSlobodnaVremena(odabranDatum); setKorak(3) }} style={{
          ...
          <div>
            ...
            {ucitavaVremena ? (
              ...
              <div style={{ background: 'white', borderRadius: '12px', padding: '2rem', textAlign: 'center', boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}>
                ...
                <button onClick={() => setKorak(2)} style={{ marginTop: '1rem', background: '#1a7a4a', color: 'white', border: 'none', borderRadius: '8px', padding: '10px 20px', cursor: 'pointer' }}>
                  Odaberi drugi datum
                </button>
              </div>
            ) : (
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px' }}>
                {slobodnaVremena.map((slot, i) => (
                  <div key={i} onClick={() => { setOdabranoVrijeme(slot); setKorak(4) }} style={{
